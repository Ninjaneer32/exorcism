...
openssl req -new -key certs/admission-tls.key -subj "/CN=exorcism.default.svc" | openssl x509 -req -CA certs/ca.crt -CAkey certs/ca.key -CAcreateserial -out certs/admission-tls.crt
